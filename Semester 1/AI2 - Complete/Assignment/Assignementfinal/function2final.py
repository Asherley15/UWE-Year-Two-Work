...
# Loop through population
    for x in range(0, P):
        ...
        for y in range(0, N):
            # Add a gene between of a value between -10 and 10 (x)
...
table = tabulate(listofaverage, headers=["Index",
                 "Mutrate", "Mutstep", "Best Fitness", "Avg Fitness"], showindex="always", tablefmt="pretty")
...
for x in range(3):
    ...
    plt.scatter(xaxis, runrandom[1], label=(
        "Random individual number: " + str(x + 1) + "Total Ind fitness: " + "{:10.3f}".format(runrandom[2])))
